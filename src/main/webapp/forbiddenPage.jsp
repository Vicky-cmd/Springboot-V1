...
<% 
	...
	String forbiddenReason = response.getHeader("forbidden-err-Msg");
	out.print("<h2 style='margin: auto; width: fit-content; font-family:serif;'>");
	out.print(forbiddenReason);
	out.print("</h2>");
%>
<div style="margin: auto; width: fit-content;">
	<div style=" margin: auto; width: fit-content;"><span style="font-size:100px;">&#128577;</span></div>
	<h4 style="font-style: italic; font-size: xx-large; font-weight: bolder; font-family: monospace; color: #ffffff;">It seems you don't have access to view this content. :(</h4>
</div>
